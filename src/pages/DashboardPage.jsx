...
export default function DashboardPage() {
    ...
    useEffect(() => {
        dispatch(fetchDocs({ page: 1, page_size: 5 }));
    }, [dispatch]);
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between">
                ...
                <div className="flex gap-2">
                    {(user?.role === "admin" ||
                        user?.role === "super_admin") && <ExportDocuments />}
                        ...
                        <table className="w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="tbl-th hidden sm:table-cell">
                                        Uploaded
                                    </th>
                            ...
                            <tbody>
                                {items.map((doc) => (
                                    <tr key={doc.id} className="tbl-tr">
                                        ...
                                        <td className="tbl-td hidden sm:table-cell text-gray-400">
                ...
                <div className="card bg-gray-900 text-white border-gray-800">
                    <div className="card-body flex items-center justify-between gap-4">
                        ...
                        <Link
                            ...
                            className="btn btn-sm bg-white text-gray-900 hover:bg-gray-100 shrink-0"
                        >
                            Review now
                        </Link>
                    </div>
